...
} from "../agreements/IInstantDistributionAgreementV1.sol";
import {
...
interface ISuperfluid {
     ...
     */
    function changeSuperTokenAdmin(
        ISuperToken token,
        address newAdmin
    ) external;
     ...
     */
    event PoolBeaconLogicUpdated(
        address indexed beaconProxy,
        address newBeaconLogic
    );
